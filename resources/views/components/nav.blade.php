<nav class="fixed top-0 flex items-center w-full justify-between p-6 bg-white z-30">
    ...
    <!-- Contact Button -->
    <a href="#" class="flex items-center rounded-full h-12 px-6 gap-[10px] bg-aktiv-green">
        <span class="font-semibold text-sm md:text-base text-white">Contact CS</span>
        <img src="{{ asset('assets/images/icons/whatsapp.svg') }}" class="w-4 md:w-6 h-4 md:h-6" alt="icon">
    </a>
</nav>
{{-- nav mobile phone --}}
